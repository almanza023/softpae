<div id="ModalProductoBodega" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
            	<form id="form_create" action="{{ route('productobodegas.store') }}" method="POST">
            		@csrf
            		@include('form.productobodega', ['crear'=>true, 'editar'=>false])
